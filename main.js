...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 20, vars: 2, consts: [[1, "principal-container"], [1, "form-container"], [1, "mid-container"], [1, "logo-container"], ["src", "../assets/img/logo.png", "alt", "logo", 1, "responsive"], [1, "principal-title"], [3, "ngSubmit"], ["userlogin", "ngForm"], ["type", "text", "id", "email", "name", "email", "placeholder", "Correo", "ngModel", "", 1, "input"], ["type", "password", "id", "password", "name", "password", "placeholder", "Contrase\u00F1a", "ngModel", "", 1, "input"], [1, "log-in"], ["href", "./register.html"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 23, vars: 0, consts: [[1, "form-container"], [1, "mid-container"], [1, "logo-container"], ["src", "../../../assets/img/logo.png", "alt", "logo", 1, "responsive"], [1, "principal-title"], ["type", "text", "id", "username", "name", "username", "placeholder", "Nombre", "required", "", 1, "input"], ["type", "text", "id", "lastname", "name", "lastname", "placeholder", "Apellido", "required", "", 1, "input"], ["type", "text", "id", "email", "name", "email", "placeholder", "Correo", "required", "", 1, "input"], ["type", "password", "id", "password", "name", "password", "placeholder", "Contrase\u00F1a", "required", "", 1, "input"], ["type", "password", "id", "confirm-password", "name", "confirm-password", "placeholder", "Confirmar Contrase\u00F1a", "required", "", 1, "input"], [1, "terms-container"], ["type", "checkbox", "id", "cbox1", "value", "checkbox"], [1, "log-in"], ["href", "#"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "main");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "article", 0);
